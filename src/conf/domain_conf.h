...
enum virDomainNetdevMacvtapType {
    ...
    VIR_DOMAIN_NETDEV_MACVTAP_MODE_VF_HOTPLUG,
    VIR_DOMAIN_NETDEV_MACVTAP_MODE_VF_HOTPLUG_HYBRID,
    VIR_DOMAIN_NETDEV_MACVTAP_MODE_LAST,
};

#define VIR_DOMAIN_NETDEV_MACVTAP_FALLBACK_MODE_LAST (VIR_DOMAIN_NETDEV_MACVTAP_MODE_BRIDGE+1)
